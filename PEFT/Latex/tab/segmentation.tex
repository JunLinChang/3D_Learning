\begin{table}[t]
  ...
  \caption{Part segmentation on the ShapeNetPart~\cite{chang2015shapenet}. The mIoU for all classes (Cls.) and for all instances (Inst.) are reported. \#TP represents the tunable parameters. \textcolor{red}{$^*$} denotes reproduced results.}
    \vspace{-10pt}
    \begin{tabular}{lcccc}
    \toprule
