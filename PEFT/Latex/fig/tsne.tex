\begin{figure*}
    ...
    \begin{subfigure}{0.3\textwidth}
        ...
        \label{fig:sub6}
    \end{subfigure}
    \caption{The visualization of the t-SNE from the test sets of ScanObjectNN (PB\_T50\_RS) by using a pre-trained PointMAE with various fine-tuning strategies. We extract the final classification features from the top linear layer for t-SNE visualizations.}
    \label{fig:tsne}
\end{figure*}