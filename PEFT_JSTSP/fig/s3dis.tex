\begin{figure*}[htbp]
    ...
    \end{minipage}
    \hfill
    \begin{minipage}{0.17\textwidth} % 第1列标题
        \centering
        DAPT
    \end{minipage}
    \hfill
    \begin{minipage}{0.17\textwidth} % 第2列标题
        \centering
        IDPT
    \end{minipage}
    \hfill
    \begin{minipage}{0.17\textwidth} % 第3列标题
        \centering
        PointGST
    \end{minipage}
    \hfill
    \begin{minipage}{0.17\textwidth} % 第4列标题
        \centering
        PLT (Ours)
    \end{minipage}
    \hfill
    \begin{minipage}{0.17\textwidth} % 第5列标题
        \centering
        GT
    \end{minipage}
    \hfill
